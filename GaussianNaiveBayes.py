...
class GaussianNaiveBayes:
    ...
    def __summarize_dataset(self, separated):
        ...
        for class_value, rows in separated.items():
            ...
            # For a Naive Bayes classifier, we can estimate the variance of each feature independently.
            # However It has the same effect of making all the non-diagonal elements of the covariance matrix zero.
    ...
    def __multivariate_gaussian_pdf(self, X, mean, cov):
        ...
        # print((1 / denominator) * np.exp(exponent))
